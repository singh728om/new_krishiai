...
export const SocialProofBar = () => {
  ...
  return (
    <div className="py-8 border-y border-krishi-cream/5 overflow-hidden whitespace-nowrap bg-krishi-black">
      <div className="inline-flex animate-marquee-scroll items-center gap-8">
        <span className="text-krishi-cream/30 uppercase tracking-[0.3em] font-headline text-[10px] px-8">
          Trusted by farmers in
        </span>
        {locations.map((loc, i) => (
          <div key={i} className="flex items-center gap-8">
            <span className="text-krishi-cream/40 font-headline font-medium tracking-wider">
              {loc}
            </span>
