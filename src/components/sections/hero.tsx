...
const DataTerminal = () => {
  ...
  return (
    ...
    >
      <div className="bg-[#0F110D] rounded-2xl p-6 border border-krishi-cream/10 shadow-2xl font-code text-sm">
        <div className="flex items-center justify-between mb-6">
          ...
          <span className="text-[10px] text-krishi-cream/40 uppercase tracking-widest">Krishi Core v2.4</span>
        </div>

        <div className="space-y-4">
          <div className="flex justify-between items-center group">
            <span className="text-krishi-cream/60">SOIL_PH</span>
            <span className="text-krishi-gold">{data.pH}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-krishi-cream/60">CROP_HEALTH</span>
            <span className="text-krishi-lime">{data.health}%</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-krishi-cream/60">MOISTURE</span>
            <span className="text-krishi-cream">{data.moisture}%</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-krishi-cream/60">PATH_RISK</span>
        ...
        <div className="mt-8 pt-4 border-t border-krishi-cream/5 text-[10px] text-krishi-cream/30">
...
export const Hero = () => {
  const headlineWords = "Farming at the speed of light.".split(" ");
    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden pt-20 grain">
      <div className="container mx-auto px-6 grid lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-7 space-y-8">
          <h1 className="text-6xl md:text-8xl font-display font-medium leading-[1.1] text-krishi-cream">
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-krishi-cream/70 max-w-xl font-body leading-relaxed"
          >
          ...
          >
            <div className="flex items-center gap-2 text-xs font-headline font-bold uppercase tracking-widest text-krishi-gold">
              <span className="text-xl">🌾</span> 40% yield increase
            </div>
            <div className="flex items-center gap-2 text-xs font-headline font-bold uppercase tracking-widest text-krishi-gold">
              <span className="text-xl">⚡</span> 3-sec diagnosis
            </div>
            <div className="flex items-center gap-2 text-xs font-headline font-bold uppercase tracking-widest text-krishi-gold">
              <span className="text-xl">₹</span> Carbon credits
            </div>
          </motion.div>
        </div>
