...
function PartnerRegistrationContent() {
  ...
  const typeParam = searchParams.get("type"); // 'rider' or 'farmer'
  
  const [isSubmitted, setIsSubmitted] = useState(false);
  const [activeTab, setActiveTab] = useState(typeParam === "farmer" ? "farmer" : "rider");

  useEffect(() => {
    if (typeParam === "farmer" || typeParam === "rider") {
